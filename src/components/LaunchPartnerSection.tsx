  ...
  return (
    <section className="relative overflow-hidden  py-24 px-4 md:px-16 text-black">
      ...
      <div className="relative z-20 text-center max-w-3xl mx-auto">
        ...
        >
          Not Just a Licence <br />A Launch Partner
        </h2>
        ...
        >
          Powering 30 000+ companies across 50+ sectors, RAKEZ turns bold ideas
          into thriving businesses right from the heart of Ras Al Khaimah, UAE.
        </p>
        <p
          className="text-gray-700 mb-6"
          data-aos="fade-up"
        ...
        >
          Backed by the Government of Ras Al Khaimah, RAKEZ offers customised
          business setup solutions, covering both free zone and non-free zone
          options.
        </p>
